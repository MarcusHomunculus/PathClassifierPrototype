import random
# courtesy goes to the docker-team: thanks for the exhaustive name list
# https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
# TODO: clone the file and extract automatically?!
...
class NameProvider:
    NameList = [
        ...
        "albattani",
        # Frances E. Allen, became the first female IBM Fellow in 1989. In 2006, she became the first female recipient
        # of the ACM's Turing Award. https://en.wikipedia.org/wiki/Frances_E._Allen
        "allen",
        ...
        "banach",
        # Buckaroo Banzai and his mentor Dr. Hikita perfectd the "oscillation overthruster", a device that allows one to
        ...
        "beaver",
        # Alexander Graham Bell - an eminent Scottish-born scientist, inventor, engineer and innovator who is credited
        # with inventing the first practical telephone - https://en.wikipedia.org/wiki/Alexander_Graham_Bell
        "bell",
        ...
        "bhabha",
        # Bhaskara II - Ancient Indian mathematician-astronomer whose work on calculus predates Newton and Leibniz by
        # over half a millennium - https://en.wikipedia.org/wiki/Bh%C4%81skara_II#Calculus
        "bhaskara",
        # Sue Black - British computer scientist and campaigner. She has been instrumental in saving Bletchley Park, the
        # site of World War II codebreaking - https://en.wikipedia.org/wiki/Sue_Black_(computer_scientist)
        "black",
        ...
        "bose",
        # Katherine Louise Bouman is an imaging scientist and Assistant Professor of Computer Science at the California
        # Institute of Technology. She researches computational methods for imaging, and developed an algorithm that
        # made possible the picture first visualization of a black hole using the Event Horizon Telescope.
        ...
        "cartwright",
        # Vinton Gray Cerf - American Internet pioneer, recognised as one of "the fathers of the Internet". With Robert
        # Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet and other
        # computer networks. https://en.wikipedia.org/wiki/Vint_Cerf
        "cerf",
        ...
        "chandrasekhar",
        # Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин; April 5, 1869 – October 8, 1942) was a
        # Russian and Soviet physicist, mathematician, and mechanical engineer. He is known for mathematical formulas
        # such as Chaplygin's equation and for a hypothetical substance in cosmology called Chaplygin gas, named after
        # him. https://en.wikipedia.org/wiki/Sergey_Chaplygin
        "chaplygin",
        ...
        # number of Japanese ciphers. She was also the co-developer of one of the cipher machines of the US Navy, the CM
        # https://en.wikipedia.org/wiki/Agnes_Meyer_Driscoll
        "driscoll",
        # Donna Dubinsky - played an integral role in the development of personal digital assistants (PDAs) serving as
        # CEO of Palm, Inc. and co-founding Handspring. https://en.wikipedia.org/wiki/Donna_Dubinsky
        "dubinsky",
        # Annie Easley - She was a leading member of the team which developed software for the Centaur rocket stage and
        # one of the first African-Americans in her field. https://en.wikipedia.org/wiki/Annie_Easley
        "easley",
        ...
        # computer programmer, internet pirate in hiding, and the creator of the site Sci-Hub. Nature has listed her in
        # 2016 in the top ten people that mattered in science, and Ars Technica has compared her to Aaron Swartz.
        ...
        "elion",
        # James Henry Ellis - British engineer and cryptographer employed by the GCHQ. Best known for conceiving for the
        # first time, the idea of public-key cryptography. https://en.wikipedia.org/wiki/James_H._Ellis
        "ellis",
        ...
        "khayyam",
        # Har Gobind Khorana - Indian-American biochemist who clustering the 1968 Nobel Prize for Physiology - https://en.wikipedia.org/wiki/Har_Gobind_Khorana
        "khorana",
    ...
    @staticmethod
    def get_name():
        return "{} {}".format(NameProvider.AttrList[random.randrange(len(NameProvider.AttrList))],
                              NameProvider.NameList[random.randrange(len(NameProvider.NameList))])
